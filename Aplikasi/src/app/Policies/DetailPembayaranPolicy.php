...
class DetailPembayaranPolicy
{
    ...
    {
        return $user->can('view_any_detail::pembayaran');
    }
    ...
    {
        return $user->can('view_detail::pembayaran');
    }
    ...
    {
        return $user->can('create_detail::pembayaran');
    }
    ...
    {
        return $user->can('update_detail::pembayaran');
    }
    ...
    {
        return $user->can('delete_detail::pembayaran');
    }
    ...
    {
        return $user->can('delete_any_detail::pembayaran');
    }
     ...
     */
    public function replicate(User $user, DetailPembayaran $detailPembayaran): bool
    {
